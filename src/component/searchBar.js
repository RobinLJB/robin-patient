...
import classNames from 'react-weui/src/utils/classnames';
import {Icon} from 'react-weui';

/**
 *  rewrite weui search component
 *
 */
class SearchBar extends React.Component {
    ...
    // submitHandle(e) {
    //   if (this.props.onSubmit) this.props.onSubmit(this.state.text,e);
    // }
    ...
    render() {
      ...
      return (
        <div className={clz}>
          ...
          <a className='weui-search-bar__cancel-btn' onClick={this.submitHandle.bind(this)}>{this.props.lang.submit}</a>
